...
import { RawSubscriptionData, Subscription, SubscriptionArgs, SubscriptionTopic } from "./subscriptions";
...
type SubscribeFn = <T extends SubscriptionTopic>(params: {
    topic: T;
...
type SendFn = (ix: Interaction | Promise<Interaction>, context: IContext, opts: IOpts) => Promise<any>;
/**
