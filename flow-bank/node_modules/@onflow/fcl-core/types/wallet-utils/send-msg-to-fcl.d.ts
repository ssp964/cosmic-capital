 ...
 * })
 */
export declare const sendMsgToFCL: (type: string, msg?: PollingResponse) => void;
/**
 ...
 * })
 */
export declare const ready: (cb: (data: any, context: {
    origin: string;
}) => void, msg?: PollingResponse) => void;
/**
 ...
 * approve(accountData)
 */
export declare const approve: (data: any) => void;
/**
 ...
 * })
 */
export declare const decline: (reason: string) => void;
/**
 ...
 * })
 */
export declare const redirect: (data: any) => void;
