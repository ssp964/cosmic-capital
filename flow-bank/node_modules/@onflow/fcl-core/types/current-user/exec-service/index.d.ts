...
export type StrategyFunction = (params: ExecStrategyParams) => Promise<StrategyResponse>;
/**
 ...
 * })
 */
export declare const execStrategy: ({ service, body, config, abortSignal, customRpc, user, opts, }: ExecStrategyParams) => Promise<StrategyResponse>;
/**
 ...
 * })
 */
export declare function execService(context: Pick<FCLContext, "config" | "sdk">, { service, msg, config, opts, platform, abortSignal, execStrategy: _execStrategy, user, }: ExecServiceParams): Promise<StrategyResponse>;
