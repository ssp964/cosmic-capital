 ...
 * })
 */
export declare function generateDependencyPin({ version, address, contractName }: GenerateDependencyPinParams, opts?: any): Promise<string>;
/**
 ...
 * })
 */
export declare function generateDependencyPinAtLatestSealedBlock({ version, address, contractName }: GenerateDependencyPinParams, opts?: any): Promise<string>;
