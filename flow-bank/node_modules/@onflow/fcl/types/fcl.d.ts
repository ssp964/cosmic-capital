 ...
 */
export declare const currentUser: import("@onflow/fcl-core").CurrentUserService;
/**
 ...
 */
export declare const mutate: (opts?: import("@onflow/fcl-core/types/exec/mutate").MutateOptions) => Promise<string>;
/**
 ...
 * fcl.authenticate();
 */
export declare const authenticate: (opts?: {}) => Promise<import("@onflow/typedefs").CurrentUser>;
/**
 ...
 */
export declare const reauthenticate: (opts?: {}) => Promise<import("@onflow/typedefs").CurrentUser>;
/**
 ...
 * fcl.signUp();
 */
export declare const signUp: (opts?: {}) => Promise<import("@onflow/typedefs").CurrentUser>;
/**
 * @description A convenience method that calls and is equivalent to `fcl.authenticate()`.
 *
 * This method can only be used in web browsers.
 ...
 * fcl.logIn();
 */
export declare const logIn: (opts?: {}) => Promise<import("@onflow/typedefs").CurrentUser>;
/**
 ...
 */
export declare const authz: (account: import("@onflow/typedefs").Account) => Promise<import("@onflow/typedefs").Account>;
