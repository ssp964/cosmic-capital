...
export declare function createAccount(context: SdkContext): (address: string, { height, id, isSealed }?: AccountQueryOptions, opts?: object) => Promise<Account>;
/**
 ...
 * ]).then(fcl.decode);
 */
export declare const account: (address: string, args_1?: AccountQueryOptions | undefined, opts?: object | undefined) => Promise<Account>;
