...
export declare function createSubscribeRawAsync(contextPromise: Promise<SdkContext> | SdkContext): <T extends SubscriptionTopic>({ topic, args, onData, onError }: SubscribeRawParams<T>, opts?: {
    node?: string;
    transport?: SdkTransport;
}) => {
    unsubscribe: () => void;
};
export declare function createSubscribeRaw(context: SdkContext): <T extends SubscriptionTopic>({ topic, args, onData, onError }: SubscribeRawParams<T>, opts?: {
    node?: string;
    transport?: SdkTransport;
}) => {
    unsubscribe: () => void;
