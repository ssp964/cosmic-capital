export interface SubscriptionHandler<T extends {
    Topic: string;
    Args: any;
    Data: any;
    ArgsDto: any;
    ...
    createSubscriber(initialArgs: T["Args"], onData: (data: T["Data"]) => void, onError: (error: Error) => void): DataSubscriber<T["ArgsDto"], T["DataDto"]>;
}
...
export declare function createSubscriptionHandler<T extends {
    Topic: string;
    Args: any;
    Data: any;
    ArgsDto: any;
